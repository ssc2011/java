                ...
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${responseDTO.dtoList}"
                                   var="dto"> <!-- responseDTO.dtoList의 각 항목을 반복하면서 dto변수에 저장 -->
                            <tr>
                                <th scope="row"><c:out value="${dto.tno}"/></th>
                                <td>
                                    <a href="/todo/read?tno=${dto.tno}&${pageRequestDTO.link}"
                                       class="text-decoration-none" data-tno="${dto.tno}"> <!-- tno는 행 번호 -->
                    ...
                    <div class="float-end">
                        <ul class="pagination flex-wrap">
                            <c:if test="${responseDTO.prev}"> <!-- responseDTO.prev 가 true일 때만 Previous 버튼 표시 -->
                                <li class="page-item">
                                    <!-- Previous 버튼을 클릭하면 responseDTO.start-1 값이 전달됨 -->
                            ...
                            <c:if test="${responseDTO.next}"> <!-- responseDTO.next 가 true일 때만 Next 버튼 표시 -->
                                <li class="page-item">
...
<script>
    document.querySelector(".pagination").addEventListener("click", function (e) {
        ...
        e.stopPropagation() // 이벤트가 부모 요소로 전파되지 않음

        const target = e.target
        if (target.tagName !== 'A') { //클릭된 요소가 a태그가 아니면 함수 종료
            return
        }
